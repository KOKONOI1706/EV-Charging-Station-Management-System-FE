...
export default function ProfilePage() {
  ...
  const handleSaveVehicle = async () => {
    ...
    try {
      ...
      // Call AuthService to update the profile with vehicle info
      const updatedUser = await AuthService.updateProfile(user.user_id, {
        vehicleInfo: {
      ...
      setVehicleData({
        make: updatedUser.vehicleInfo?.make || "",
        model: updatedUser.vehicleInfo?.model || "",
        year: updatedUser.vehicleInfo?.year || new Date().getFullYear(),
        batteryCapacity: updatedUser.vehicleInfo?.batteryCapacity || 0,
      });
