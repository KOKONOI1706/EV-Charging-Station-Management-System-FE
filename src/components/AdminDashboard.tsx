          ...
          <div className="grid md:grid-cols-2 gap-6">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold">8AM - 10AM, 5PM - 7PM</span>
                  </div>
                  <div className="flex justify-between items-center">
                  ...
                  <div className="flex justify-between items-center">
                    <span>Most Popular Station Type</span>
                    <span className="font-bold">DC Fast Charging</span>
                  </div>
                  <div className="flex justify-between items-center">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span>Average Revenue per Session</span>
